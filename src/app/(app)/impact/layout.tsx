  ...
  return (
    <div className="flex min-h-[calc(100vh-0px)] flex-col">
      <div className="flex-1 p-4 sm:p-8">
        <h2 className="text-headline-lg text-on-surface">Impact lab</h2>
        <p className="mt-1 max-w-2xl text-body-md text-on-surface-variant">
          Exploring — not your live factory. Change costs or add machines, see
          money move below. Save a what-if, or make it live only when you are
          ready.
        </p>
        <div className="mt-4">
          <ImpactSectionNav />
